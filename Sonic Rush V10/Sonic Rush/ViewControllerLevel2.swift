...
class ViewControllerLevel2: UIViewController, ReleaseDelegate2, UpdateAngle2{
    ...
    @IBOutlet weak var ScoreLabel: UILabel!
        ...
        func CreateSonic() {
            ...
            collisionBehavior.addBoundary(withIdentifier: "obstacle" as NSString, from: CGPoint(x:w*0.4,y: h*0.4), to: CGPoint(x:w*0.6,y:h*0.6))
            dynamicAnimator.addBehavior(collisionBehavior)
            ...
            //rightBoundary.frame = CGRect(x:w*0.6, y:0, width: 1, height: h)
            //view.addSubview(rightBoundary)
            
            //Add collision for obstacle
            let obstacleCol = UIImageView (image: nil)
            obstacleCol.image = UIImage(named: "BoundaryImage.png")
            obstacleCol.frame = CGRect(x:w*0.4, y:h*0.4, width: w*0.2, height: h*0.2)
            view.addSubview(obstacleCol)
    ...
    override func viewDidLoad() {
            ...
            Obstacle.image = UIImage(named: "BoundaryImage.png")
        Obstacle.frame = CGRect(x:w*0.5, y:h*0.4, width: 40, height: 50)
