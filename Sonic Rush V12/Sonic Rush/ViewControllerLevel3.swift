...
protocol UpdateAngle3 {
    func UpdateAngle(_ xy: CGPoint)
}

protocol ReleaseDelegate3 {
    func CreateSonic()
}

class ViewControllerLevel3: UIViewController, ReleaseDelegate3, UpdateAngle3{
    ...
    func PlayBGMusic(){
        ...
        func CreateObstacle(){
            ...
            let obsframe = CGRect(x:w*randomObstaclePosX,y:h*randomObstaclePosY,width: w*0.2,height: h*0.3)
        ...
        func CreateSonic() {
            ...
            self.collisionBehavior.action = {
               ...
               for coin in self.coinViewArray{
                ...
                else if sonicView.frame.intersects(self.obstacle!.frame){
                    self.obstacle!.removeFromSuperview()
                    self.obstacle!.center = CGPoint(x: self.w*1.4, y: self.h*1.4)
                    self.CreateObstacle()
                    
                    
                //self.randomObstaclePosX = CGFloat.random(in: 0.4..<0.6)
                //self.randomObstaclePosY = CGFloat.random(in: 0.3..<0.6)
                //self.snapBehavior = UISnapBehavior(item: self.obstacle!, snapTo: CGPoint(x: self.w*self.randomObstaclePosX, y: self.h*self.randomObstaclePosY))
    ...
    override func viewDidLoad() {
            ...
            AimRelease.myDelegate3 = self
            AimRelease.myDelegateAngle3 = self
        ...
        func end(){
            ...
            endViewController.CurrentLevel = "three"
            endViewController.NextLevel = "endGame"
